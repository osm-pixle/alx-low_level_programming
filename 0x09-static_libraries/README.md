...
INTRODUCTION TO FILES closed_bookclosed_bookclosed_book:
libholberton.a: Create the static library libholberton.a containing all the functions listed belowIf you haven’t coded all of the above functions create empty ones with the right prototype.
